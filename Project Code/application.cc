...
//void Application::OnSayHello(Awesomium::WebView* caller, const JSArray& args) {
//    this->ShowMessage("Hello!");
//}

////void Application::BindMethods(WebView* web_view){
...
Application::Application() : 
  ...
  SDL_WM_SetCaption("ATOS Directory Explorer","");
...
void Application::OnLaunch(Awesomium::WebView* caller) {
}
